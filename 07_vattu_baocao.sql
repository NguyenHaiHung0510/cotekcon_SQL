...
('SDVT00001', 1, 1, 20000, 1, 85000, '2023-04-01 08:00:00'),
('SDVT00002', 1, 3, 500000, 8, 18000, '2023-05-15 09:00:00'),
('SDVT00003', 1, 7, 5000, 1, 1400000, '2023-06-10 10:00:00'),
('SDVT00004', 1, 11, 2000, 5, 750000, '2024-03-01 11:00:00'),
('SDVT00005', 1, 18, 500, 7, 5500000, '2024-07-20 14:00:00'),
('SDVT00006', 1, 17, 400, 11, 22000000, '2024-08-01 15:00:00');

-- DA002 (Landmark 69)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00007', 2, 1, 50000, 1, 82000, '2022-02-01 08:00:00'),
('SDVT00008', 2, 3, 1500000, 2, 17500, '2022-03-10 09:00:00'),
('SDVT00009', 2, 30, 10000, 1, 350000, '2022-04-01 10:00:00'),
('SDVT00010', 2, 7, 20000, 1, 1350000, '2022-06-01 11:00:00'),
('SDVT00011', 2, 11, 10000, 5, 780000, '2023-05-01 14:00:00'),
('SDVT00012', 2, 12, 32, 6, 1200000000, '2023-08-15 15:00:00'),
('SDVT00013', 2, 8, 1000, 3, 2100000, '2024-01-10 16:00:00');

-- DA003 (Ecopark Hải Dương)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00014', 3, 1, 15000, 1, 85000, '2023-06-01 08:00:00'),
('SDVT00015', 3, 4, 2000000, 1, 1200, '2023-07-01 09:00:00'),
('SDVT00016', 3, 5, 10000, 1, 180000, '2023-07-01 10:00:00'),
('SDVT00017', 3, 26, 500, 9, 2800000, '2024-05-15 11:00:00'),
('SDVT00018', 3, 14, 1500, 13, 450000, '2024-08-20 14:00:00');

-- DA004 (Hầm Đèo Cả 2)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00019', 4, 7, 50000, 1, 1450000, '2022-07-01 08:00:00'),
('SDVT00020', 4, 3, 2000000, 8, 19000, '2022-08-01 09:00:00'),
('SDVT00021', 4, 28, 50000, 14, 15000, '2022-09-01 10:00:00'),
('SDVT00022', 4, 29, 10000, 8, 25000, '2023-01-15 11:00:00'),
('SDVT00023', 4, 20, 5000, 4, 45000, '2024-02-10 14:00:00');

-- DA005 (Estella Heights GĐ 3)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00024', 5, 7, 3000, 1, 1400000, '2023-12-01 08:00:00'),
('SDVT00025', 5, 22, 5000, 10, 220000, '2024-07-01 09:00:00'),
('SDVT00026', 5, 13, 1000, 1, 1100000, '2024-09-01 10:00:00'),
('SDVT00027', 5, 18, 300, 7, 6000000, '2024-11-01 11:00:00');

-- DA006 (FLC Quy Nhơn)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00028', 6, 1, 5000, 1, 80000, '2022-05-01 08:00:00'),
('SDVT00029', 6, 5, 3000, 1, 175000, '2022-06-01 09:00:00'),
('SDVT00030', 6, 13, 3000, 1, 1200000, '2023-03-01 10:00:00'),
('SDVT00031', 6, 8, 300, 3, 2000000, '2023-06-15 11:00:00');

-- DA007 (Intel GĐ 2)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00032', 7, 7, 10000, 1, 1500000, '2023-02-01 08:00:00'),
('SDVT00033', 7, 9, 20000, 4, 18000, '2023-04-01 09:00:00'),
('SDVT00034', 7, 21, 15000, 11, 35000, '2023-05-01 10:00:00'),
('SDVT00035', 7, 17, 500, 11, 25000000, '2023-11-01 11:00:00');

-- DA008 (Điện mặt trời)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00036', 8, 2, 100000, 2, 17000, '2022-03-01 08:00:00'),
('SDVT00037', 8, 20, 10000, 4, 40000, '2022-05-01 09:00:00'),
('SDVT00038', 8, 28, 5000, 14, 12000, '2022-06-01 10:00:00');

-- DA009 (Cầu Thạch Bản)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00039', 9, 7, 30000, 1, 1450000, '2024-02-01 08:00:00'),
('SDVT00040', 9, 3, 1000000, 8, 19500, '2024-04-01 09:00:00'),
('SDVT00041', 9, 29, 20000, 8, 27000, '2024-07-01 10:00:00');

-- DA010 (Hưng Thịnh Phát Plaza)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00042', 10, 1, 8000, 1, 83000, '2022-09-01 08:00:00'),
('SDVT00043', 10, 2, 200000, 2, 17000, '2022-10-01 09:00:00'),
('SDVT00044', 10, 4, 1000000, 1, 1100, '2022-11-01 10:00:00'),
('SDVT00045', 10, 22, 3000, 10, 210000, '2023-10-01 11:00:00'),
('SDVT00046', 10, 18, 200, 7, 4500000, '2024-02-01 14:00:00');

-- DA011 (Data Center MWG)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00047', 11, 7, 2000, 1, 1500000, '2023-10-01 08:00:00'),
('SDVT00048', 11, 20, 30000, 4, 50000, '2024-01-15 09:00:00'),
('SDVT00049', 11, 21, 20000, 11, 38000, '2024-02-15 10:00:00'),
('SDVT00050', 11, 17, 300, 11, 30000000, '2024-06-01 11:00:00');

-- DA012 (Cao tốc)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00051', 12, 1, 100000, 1, 80000, '2022-04-15 08:00:00'),
('SDVT00052', 12, 6, 50000, 1, 210000, '2022-05-15 09:00:00'),
('SDVT00053', 12, 3, 1000000, 8, 18500, '2022-07-01 10:00:00'),
('SDVT00054', 12, 7, 30000, 1, 1350000, '2022-08-01 11:00:00');

-- DA013 (NovaWorld Phan Thiết)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00055', 13, 4, 3000000, 1, 1250, '2022-11-01 08:00:00'),
('SDVT00056', 13, 5, 15000, 1, 180000, '2022-11-01 09:00:00'),
('SDVT00057', 13, 23, 5000, 12, 85000, '2023-08-01 10:00:00'),
('SDVT00058', 13, 26, 1000, 9, 2900000, '2024-01-10 11:00:00'),
('SDVT00059', 13, 15, 2000, 13, 1100000, '2024-05-15 14:00:00');

-- DA014 (VinMec Mở rộng)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00060', 14, 7, 1500, 1, 1500000, '2023-08-01 08:00:00'),
('SDVT00061', 14, 18, 400, 7, 7000000, '2024-02-01 09:00:00'),
('SDVT00062', 14, 9, 5000, 4, 18000, '2024-04-01 10:00:00'),
('SDVT00063', 14, 16, 1000, 11, 280000, '2024-07-01 11:00:00');

-- DA015 (Phú Mỹ Hưng)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00064', 15, 7, 4000, 1, 1400000, '2022-06-01 08:00:00'),
('SDVT00065', 15, 3, 300000, 2, 18000, '2022-08-01 09:00:00'),
('SDVT00066', 15, 13, 2500, 1, 1300000, '2023-09-01 10:00:00'),
('SDVT00067', 15, 8, 500, 3, 2200000, '2024-03-01 11:00:00'),
('SDVT00068', 15, 12, 10, 6, 900000000, '2024-05-01 14:00:00');

-- DA016 (Waterpoint GĐ 2)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00069', 16, 1, 12000, 1, 84000, '2023-03-01 08:00:00'),
('SDVT00070', 16, 4, 1500000, 1, 1150, '2023-04-01 09:00:00'),
('SDVT00071', 16, 10, 20000, 15, 14000, '2023-09-01 10:00:00'),
('SDVT00072', 16, 26, 400, 9, 2800000, '2024-06-01 11:00:00');

-- DA017 (Tổng kho Nhà Bè)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00073', 17, 7, 5000, 1, 1400000, '2022-10-01 08:00:00'),
('SDVT00074', 17, 3, 400000, 8, 19000, '2022-11-01 09:00:00'),
('SDVT00075', 17, 23, 10000, 12, 90000, '2023-05-01 10:00:00'),
('SDVT00076', 17, 28, 10000, 14, 14000, '2023-07-01 11:00:00');

-- DA018 (SUDICO Mỹ Đình)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00077', 18, 7, 2000, 1, 1400000, '2023-05-01 08:00:00'),
('SDVT00078', 18, 3, 100000, 2, 18000, '2023-07-01 09:00:00'),
('SDVT00079', 18, 11, 3000, 5, 750000, '2024-04-01 10:00:00'),
('SDVT00080', 18, 12, 4, 6, 850000000, '2024-08-01 11:00:00');

-- DA019 (Saigon Sports City)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00081', 19, 7, 10000, 1, 1450000, '2024-03-01 08:00:00'),
('SDVT00082', 19, 3, 800000, 8, 19000, '2024-05-01 09:00:00'),
('SDVT00083', 19, 13, 5000, 1, 1100000, '2025-01-15 10:00:00'),
('SDVT00084', 19, 23, 10000, 12, 88000, '2025-03-01 11:00:00');

-- DA020 (Long Thành)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00085', 20, 1, 200000, 1, 80000, '2022-02-01 08:00:00'),
('SDVT00086', 20, 7, 100000, 1, 1350000, '2022-05-01 09:00:00'),
('SDVT00087', 20, 3, 5000000, 2, 17500, '2022-08-01 10:00:00'),
('SDVT00088', 20, 6, 100000, 1, 210000, '2023-01-01 11:00:00'),
('SDVT00089', 20, 20, 100000, 4, 48000, '2023-06-01 14:00:00'),
('SDVT00090', 20, 11, 20000, 5, 800000, '2024-01-01 15:00:00');

-- DA021 (Cáp treo Bà Nà)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00091', 21, 3, 50000, 8, 19000, '2022-12-01 08:00:00'),
('SDVT00092', 21, 29, 30000, 8, 28000, '2023-02-01 09:00:00'),
('SDVT00093', 21, 28, 10000, 14, 15000, '2023-03-01 10:00:00');

-- DA022 (Moonlight Boulevard)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00094', 22, 7, 3000, 1, 1350000, '2022-08-01 08:00:00'),
('SDVT00095', 22, 2, 150000, 2, 17000, '2022-10-01 09:00:00'),
('SDVT00096', 22, 15, 800, 13, 1000000, '2023-09-01 10:00:00'),
('SDVT00097', 22, 18, 250, 7, 4800000, '2024-01-15 11:00:00');

-- DA023 (Akari City GĐ 2)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00098', 23, 1, 10000, 1, 84000, '2023-07-01 08:00:00'),
('SDVT00099', 23, 7, 4000, 1, 1400000, '2023-09-01 09:00:00'),
('SDVT00100', 23, 30, 2000, 1, 340000, '2023-11-01 10:00:00'),
('SDVT00101', 23, 12, 8, 6, 880000000, '2024-10-01 11:00:00');

-- DA024 (Điện gió Bạc Liêu)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00102', 24, 7, 8000, 1, 1450000, '2023-01-01 08:00:00'),
('SDVT00103', 24, 3, 500000, 8, 19000, '2023-03-01 09:00:00'),
('SDVT00104', 24, 29, 10000, 8, 27000, '2023-06-01 10:00:00'),
('SDVT00105', 24, 20, 20000, 4, 45000, '2023-09-01 11:00:00');

-- DA025 (Aqua City)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00106', 25, 1, 10000, 1, 82000, '2022-05-15 08:00:00'),
('SDVT00107', 25, 4, 1200000, 1, 1100, '2022-07-01 09:00:00'),
('SDVT00108', 25, 8, 800, 3, 2000000, '2023-10-01 10:00:00'),
('SDVT00109', 25, 27, 2000, 10, 150000, '2024-02-01 11:00:00'),
('SDVT00110', 25, 18, 350, 7, 5000000, '2024-05-01 14:00:00');

-- DA026 (Nhà máy bia kutzman)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00111', 26, 7, 1000, 1, 1400000, '2023-11-01 09:00:00'),
('SDVT00112', 26, 23, 5000, 12, 90000, '2024-03-01 10:00:00'),
('SDVT00113', 26, 26, 100, 9, 3000000, '2024-06-01 11:00:00'),
('SDVT00114', 26, 19, 2000, 8, 22000, '2024-02-01 14:00:00');

-- DA027 (Nhà máy bia hơi Hải Xồm)
INSERT INTO SUDUNG_VATTU (MaSDVT, id_DUAN, id_DANHMUC_VATTU, SoLuongSuDung, id_NHACUNGCAP, DonGiaApDung, ThoiGianMua) VALUES
('SDVT00115', 27, 7, 500, 1, 1400000, '2024-06-01 09:00:00'),
('SDVT00116', 27, 10, 5000, 15, 15000, '2024-08-01 10:00:00'),

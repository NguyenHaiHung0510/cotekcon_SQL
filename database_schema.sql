...
CREATE TABLE LUONG_NV (
    ...
    LuongCoBan DECIMAL(15, 0) NOT NULL DEFAULT 0 CHECK ( LuongCoBan >= 0 ),
    PhuCap DECIMAL(15, 0) NOT NULL DEFAULT 0 CHECK ( PhuCap >= 0 ),
    LamThem DECIMAL(15, 0) NOT NULL DEFAULT 0 CHECK ( LamThem >= 0 ),
    Thuong DECIMAL(15, 0) NOT NULL DEFAULT 0 CHECK ( Thuong >= 0 ),
    KhauTru DECIMAL(15, 0) NOT NULL DEFAULT 0 CHECK (KhauTru >= 0),
    FOREIGN KEY (id_NHANVIEN) REFERENCES NHANVIEN(id) ON DELETE CASCADE ON UPDATE CASCADE
);
